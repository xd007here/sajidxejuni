...
print  """
 ...
 \033[1;96m           тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд  тХ▒тЦФтЦФтЦФтЦФтФКтФКтФКтФКтЦФтЦФтЦФтЦФтХ▓  тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд
  \033[1;96m          тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд
       \033[1;93m    тЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦТтЦТWelcome To VirusтЦТтЦТтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИ
...
\033[1;94mFacebook  \033[1;91m: \033[1;91mVirus-Society
\033[1;94mWhatsapp  \033[1;91m: \033[1;91m+xxx
...
jalan('\033[1;92m   .........................Virus.........................:')
jalan("\033[1;93m   тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд Welcome to Virus Society тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд   ")
...
jalan("\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИтФИWhatsApp Num :  Main Nhi BataongaтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Virus_hacker
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mChal Mera Putar pass galat he"
...
def login():
	...
	try:
		...
		jalan(' \033[1;92m     Notice:тШЮ \033[1;97mwash your hands every 1 hour' )
                jalan(' \033[1;92m    Warning:тШЮ \033[1;95mCloning me kuch nh rakha ja k samosy bech' )
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://m.facebook.com/thezkkhoso')
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\x1b[1;91mBsdk token sahe daal"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	try:
		...
		os.system('clear')
		print"\033[1;91mApka Account Lore Lag Chuka Ha"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
		print"\x1b[1;92mBhikari Hotspot Le Ly Kise Se"
		keluar()
	os.system("clear") #Dev:Virus_hacker
	print logo
